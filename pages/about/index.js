    ...
    <div className='container mx-auto h-full flex flex-col items-center xl:flex-row'>
      <div className='flex-1 flex flex-col justify-center'>
        ...
        variants={fadeIn('right', 0.4)} initial="hidden" animate="show" exit="hidden" 
         className='max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0 '>10 years ago, I began freelancing as a developer. Since then Ive done remote work
          for agencies, counsulted for startups, and collaborated on digital products for business and consumer use.
        </motion.p>
        <motion.div 
